  ...
  <div class="container" id="products">
    ...
    if(isset($_REQUEST["search"])){ ?>
      ...
      if(!(empty($_REQUEST["searchBox1"])) && !(empty($_REQUEST["searchBox2"])) && !(empty($_REQUEST["searchBox3"]))){
        ...
        JOIN seatdetails12
        ON roomdetails12.roomId = seatdetails12.roomId
        WHERE messinfo12.messLocation LIKE '%$searchV1%' AND messinfo12.messType = '$searchV2' AND seatdetails12.seatRent BETWEEN $seatRent1 AND $seatRent2";
      }
        ...
        JOIN seatdetails12
        ON roomdetails12.roomId = seatdetails12.roomId
        WHERE messinfo12.messLocation LIKE '%$searchV1%'";
        ...
        JOIN seatdetails12
        ON roomdetails12.roomId = seatdetails12.roomId
        WHERE messinfo12.messType = '$searchV2'";;
        ...
        JOIN seatdetails12
        ON roomdetails12.roomId = seatdetails12.roomId
        WHERE seatdetails12.seatRent BETWEEN $seatRent1 AND $seatRent2";
        ...
        JOIN seatdetails12
        ON roomdetails12.roomId = seatdetails12.roomId
        WHERE messinfo12.messLocation LIKE '%$searchV1%' AND messinfo12.messType = '$searchV2'";
        ...
        JOIN seatdetails12
        ON roomdetails12.roomId = seatdetails12.roomId
        WHERE messinfo12.messLocation LIKE '%$searchV1%' AND seatdetails12.seatRent BETWEEN $seatRent1 AND $seatRent2";
        ...
        JOIN seatdetails12
        ON roomdetails12.roomId = seatdetails12.roomId
        WHERE messinfo12.messType = '$searchV2' AND seatdetails12.seatRent BETWEEN $seatRent1 AND $seatRent2";
        ...
        while ($searchAll = mysqli_fetch_array($runSearchQuery)) { ?>
          <div id="seatInfoWrapper">
           ...
           <div class="col-md-5" id="details4">
            ...
            <a href="bookNow.php?userId=<?php echo $messOwner; ?>" class="btn" id="bookNow">Book Now</a>
    ...
    <div id="noMatch">No maching Result</div>
  <?php }
}
